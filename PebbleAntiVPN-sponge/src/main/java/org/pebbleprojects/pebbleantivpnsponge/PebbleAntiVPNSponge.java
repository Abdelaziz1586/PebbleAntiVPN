package org.pebbleprojects.pebbleantivpnsponge;
 ...
 */
@Plugin("PebbleAntiVPNSponge")
public class PebbleAntiVPNSponge {

    private final PluginContainer container;
    private final Logger logger;

    @Inject
    PebbleAntiVPNSponge(final PluginContainer container, final Logger logger) {
    ...
    public void onConstructPlugin(final ConstructPluginEvent event) {
        ...
        this.logger.info("Constructing PebbleAntiVPN");
    }
    ...
    public void onRegisterCommands(final RegisterCommandEvent<Command.Parameterized> event) {
        ...
        event.register(this.container, Command.builder()
                ...
                .permission("PebbleAntiVPNSponge.command.greet")
                .executor(ctx -> {
